...
class AccountInfo extends Component {
  ...
  handleSubmit = () => {
    ...
    this.props.editUserData(userData).then(() => {
  ...
  render() {
    ...
    return (
      <Container className={url !== 'checkout' ? classes.normal : classes.checkout}>
        {url !== 'checkout' && <CustomText title={'Account Information'} type={'title'}/>}
