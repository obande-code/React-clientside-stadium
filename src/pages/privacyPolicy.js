    ...
    return (
      <>
        <div className={classes.root}>
          ...
          <div>
            <p>Effective: January 22, 2020</p>
            <p>
              Parkr Technologies, Inc., a Delaware corporation (“Prked,” “we,” “us”) takes your privacy very seriously. We provide this Privacy Policy to inform you of our policies and procedures regarding the collection, use and disclosure of personal information we receive from Users of our website at Prked.com (the “Website”) and the Prked iOS mobile device application (the “App”) or any other products provided by Parkr Technologies, Inc. The Website, App, and all other Prked services are collectively referred to as the “Services.” This Privacy Policy applies only to information that you provide to us through use of the Services or by direct contact with a representative of Prked. By using the Services, you are agreeing to be bound by these policies. Our privacy policy will be updated as necessary. We will notify you of any material changes and all updates to the privacy policy will be posted on the Website and within the Mobile App.
            </p>
            <h2>Key Terms</h2>
            <h3>Services</h3>
            <p>
              The website at Prked.com (the “Website”) and the Prked iOS mobile device application (the “App”) or any other products provided by Parkr Technologies, Inc. The Website, App, and all other Prked services are collectively referred to as the “Services.”
            </p>
            <h3>User</h3>
            <p>
            ...
            <h3>Cookies</h3>
            <p>
              Like many websites, we also use automated data collection tools such as “cookies” and “web beacons” to collect certain information. “Cookies” are small text files that we transfer to your computer’s hard disk for record-keeping purposes. We use “persistent cookies” to save your registration ID and login password for future logins to the Website; and we use “session ID cookies” to enable certain features of the Website, to better understand how you interact with the Website and to monitor aggregate usage and web traffic routing on the Website. You can instruct your browser, by changing its options, to stop accepting cookies or to prompt you before accepting a cookie from the websites you visit. If you do not accept cookies, however, you may not be able to use all portions of the Website or all functionality of our Services. Note that this Privacy Policy covers only our use of cookies and does not include use of cookies by third parties.
            </p>
            <h3>Third Parties</h3>
            <p style={{marginBottom: 0}}>
              We may also allow third parties, including, but not limited to Google Analytics, to place cookies on the Website. Third parties use these technologies to help us analyze how you use the Website and to market and advertise to you on the Website and third party websites. These cookies also help us detect or prevent fraud or conduct risk assessments, or to collect information about your activities on the Website. To prevent Google Analytics from using your information for analytics, you may install the
            </p>
            <a href="#">Google Analytics Opt-Out Browser</a>
            <p style={{marginBottom: 0}}>
              . To opt out of Google Analytics for display advertising or customize Google display network ads, you can visit the
            </p>
            <a href="#">Google Ads Settings</a>
            <p>
              page. We do not control any of these opt-out links and are not responsible for the availability or accuracy of these mechanisms.
            </p>
            <h3>Web Beacons</h3>
            <p>
            ...
            <h3>Information Shared with Services Providers and Analysts</h3>
            <p>
            ...
            <h3>Information Disclosed to Protect Us and Others</h3>
            <p>
