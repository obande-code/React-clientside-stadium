...
import DianaImage from "../images/Diana.jpg";
import GarrickImage from "../images/Garrick.jpg";
import RositaImage from "../images/Rosita.jpg";
import JohnImage from "../images/John.jpg";
import DavidImage from "../images/David.jpg";
import ZackImage from "../images/prked.png";
...
import heroFirst from "../images/ParkedCar.png";
...
const testimonialData = [
  {
    name: "Diana C",
    location: "Driveway on 37th Street, Miami Gardens",
    rating: "5",
    comment:
      "Simple and easy to use. Found parking in seconds and booking it was even quicker. Saved me a lot of time circleing the block looking for parking.",
    avatar: DianaImage,
  },
  {
    name: "Garrick L",
    location: "Driveway on Don Shula Dr, Miami",
    rating: "5",
    comment:
      "Found parking 5 minutes from the Dolphins stadium for a fraction of the price. And on top of that, I didn't have to wait in the traffic while entering and leaving the stadium parking!",
    avatar: GarrickImage,
  },
  {
    name: "David M",
    location: "Driveway on South Miami Ave, Miami",
    rating: "5",
    comment:
  ...
  {
    name: "John S",
    location: "Parking lot on SE 1st Street, Miami",
    rating: "5",
    comment:
      "I don't usually leave reviews, but Prked was a great experience. We parked our car here on our trip to visit Miami and everything went smoothly and it was a fraction of the price anywhere else.",
    avatar: JohnImage,
  },
  {
    name: "Sofia C",
    ...
    rating: "5",
    comment:
      "Great alternative to stadium parking. Finding a spot took seconds and booking it was even faster! Look forward to parking there every game day. Its quicker, cheaper, and safer!",
    avatar: SofiaImage,
  },
  {
    name: "Rosita S",
    ...
    rating: "5",
    comment:
      "Simple and easy-to-use app, perfect for my commute to work. Saves me a lot of time, money, and stress.",
    avatar: RositaImage,
  },
];
...
class home extends Component {
  ...
  checkDatesValidity() {
    ...
    if (startDate && endDate) {
      ...
      if (!(startDate > 0 && endDate > 0)) {
        ...
        this.setState({ datesValid: false });
        return false;
      } else if (endDate - startDate < 900000) {
        console.log("4");
        // if less than an hour, not valid
        this.setState({ datesValid: false });
        return false;
      } else if (startDate.getTime() < Date.now()) {
        //checks if start date already happened
  ...
  userLocationInputCallback(location) {
    ...
    // Create the sdk to check for a location detail
            ...
            <div className={classes.heroContent}>
              <div className={classes.heroContentInner}>
                ...
                <p className={classes.heroDescriptionMobile}>
                  Choose from thousands of spaces
                </p>
                <p className={classes.heroDescriptionDesktop}>
                  Choose from thousands of available spaces, or reserve your
                  space in advance. Join countless drivers enjoying easy
                  parking.
                </p>
    ...
    return (
      <div className={classes.downloadApp}>
        ...
        <div className={classes.downloadAppRight}>
          <h2>There is more to love in the app</h2>
          <div>
            <b>Reminders for when your booking ends</b>
            <p>Never run the risk of fines</p>
          </div>
          <div>
            <b>Apple supported</b>
            <p>
              Pay using Apple Pay for convenience and speed. You’ll receive a
              receipt like normal.
            </p>
          </div>
          <div>
            <b>Extend if you need more time</b>
      ...
      <div className={classes.parkingMadeEasy}>
        ...
        <div className={classes.parkingMadeEasyItems}>
          <div className={classes.parkingMadeEasyItem}>
            ...
            <p>Choose from thousands of spaces across the US</p>
          ...
          <div className={classes.parkingMadeEasyItem}>
            ...
            <p>Reserve in advance at over 1,000+ locations</p>
          </div>
          <div className={classes.parkingMadeEasyItem}>
            <img
              src={seamless}
